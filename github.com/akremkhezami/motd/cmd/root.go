...
to quickly create a Cobra application.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if preview {
			...
			// Write content
			f, err := os.OpenFile("filetest", os.O_WRONLY, 0644)

			if err != nil {
				fmt.Println("Error: Unable to open to file")
				os.Exit(1)
			}
...
func init() {
	...
	rootCmd.Flags().BoolVarP(&preview, "preview", "v", false, "Preview message instead of writing to our /etc/motd")
